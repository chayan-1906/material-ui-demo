...
export const MuiButton = () => {
    ...
    return (
        <Stack p={4} spacing={4}>
            ...
            <Stack direction='row'>
                <ButtonGroup variant='outlined' size='small' color='secondary' aria-label='alignment button group'>
            ...
            <Stack direction='row'>
                <ButtonGroup variant='contained' orientation='vertical' color='error'
                             ...
                             onClick={() => alert('Clicked on vertically aligned button group')}>
                    <Button>Top</Button>
                    <Button>Center</Button>
            ...
            <Stack direction='row'>
                <ToggleButtonGroup aria-label='text formatting' value={formats} onChange={handleFormatChange}
                                   size='small' color='success' exclusive>
                    <ToggleButton value='bold' aria-label='bold'><FormatBoldRounded/></ToggleButton>
                    <ToggleButton value='italic' aria-label='italic'><FormatItalicRounded/></ToggleButton>
                    <ToggleButton value='underlined' aria-label='underline'><FormatUnderlinedRounded/></ToggleButton>
                </ToggleButtonGroup>
            </Stack>
        </Stack>
    )
